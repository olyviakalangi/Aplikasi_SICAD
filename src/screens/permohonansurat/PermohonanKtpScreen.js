...
const RenderHeader = () => {
  return (
    <SafeAreaView style={[GlobalCss.containerPaddingX]}>
      <CustomHeader title="Permohonan Ktp" />
    </SafeAreaView>
  );
};
      ...
      data: [
        {
          ...
          value: formDataUser.permohonan_ktp,
          type: "options",
          placeholder: "Pilih Permohonan KTP",
          required: true,
          options: [
            {
              id: "1",
...
export default function PermohonanKtpScreen() {
